...
public class ServiceSceneController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
         sName.getItems().addAll(" Car Loan", "Home Loan","Education Loan", "Life Insurance");
    ...
    private void addService(ActionEvent event) {
        ...
        String name = sName.getValue().toString();
        ...
        sWarnMsg.setText("Please Enter Date.");
         ...
         if(accNum==null || accNum.isEmpty()){
          ...
          if(name==null || name.isEmpty()){
           sWarnMsg.setText("Please Choose Name of Service.");
            sName.requestFocus();
            return;
        }
